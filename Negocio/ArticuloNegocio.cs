...
namespace Negocio
{
    public class ArticuloNegocio
    {
        ...
        public bool existeMarcaCategoriaArticulo(string nombre, int idMarca, int idCategoria, int idArticulo)
        {
            dbAccess datos = new dbAccess();

            try
            {
                datos.setQuery("SELECT Id FROM ARTICULOS WHERE Nombre = @nombre   AND IdMarca = @idMarca   AND IdCategoria = @idCategoria  AND Id <> @idArticulo");
                datos.setParameter("@nombre", nombre);
                datos.setParameter("@idMarca", idMarca);
                datos.setParameter("@idCategoria", idCategoria);
                datos.setParameter("@idArticulo", idArticulo);
        ...
        public int buscarIdArticulo(Articulo articulo)
        {
            dbAccess datos = new dbAccess();
